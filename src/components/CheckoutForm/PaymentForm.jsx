...
const PaymentForm = ({ checkoutToken, shippingData, backStep, nextStep, onCaptureCheckout }) => {
        ...
        if(error) {
            ...
            const orderData = {
                ...
                shipping: {
                    ...
                    posta_zip_code: shippingData.zip,
    ...
    return (
        <>
            ...
            <Divider />
            <Typography variant="h6" gutterBotton style={{magin: '20px 0'}}>Payment Method</Typography>
                ...
                <ElementsConsumer>
                    {({ elements, stripe }) => (
                        <form onSubmit={(e) => handleSubmit(e, elements, stripe)}>
                            <CardElement />
                            <br /><br />
                            <div stype={{ diplay: 'flex', justifyContent: 'space-between'}}>
